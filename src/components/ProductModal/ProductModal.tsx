...
const ProductModal = ({show, onHide, title, modalType, prod, refreshData}:ProductModalProps) => {
    ...
    // utiliza el esquema de validación para crear un formulario dinámico y que bloquee en caso de errores
            ...
            {modalType === ModalType.DELETE ? (
                <> 
                    <Modal show={show} onHide={onHide} centered backdrop="static">
                        ...
                        <Modal.Body>
                            <p style={{textAlign:"center"}}>¿Está seguro que desea eliminar el producto <br/> <strong>{prod.title}</strong>?</p>
                        </Modal.Body>
                        <Modal.Footer>
